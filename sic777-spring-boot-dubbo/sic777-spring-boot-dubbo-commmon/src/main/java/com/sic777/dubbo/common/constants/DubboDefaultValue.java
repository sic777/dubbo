...
import com.sic777.dubbo.common.type.*;
...
public class DubboDefaultValue {
     ...
     * 默认的环境
     */
    public final static String DEFAULT_ENV = Environment.DEVELOP.getEnvironment();
    /**
     * 默认编码
     */
     ...
     * 默认的日志容器
     */
    public final static String DEFAULT_LOGGER = ApplicationLogType.LOG4J.getType();
    /**
     * 默认组织
     */
     ...
     * 默认远程服务调用超时时间(毫秒)
     */
    public final static int DEFAULT_REMOTE_SERVER_TIMEOUT = 3000;
    /**
