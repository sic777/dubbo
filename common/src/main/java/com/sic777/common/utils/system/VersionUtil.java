...
public final class VersionUtil {
    ...
    private static final String VERSION = getVersion(VersionUtil.class,
            CurrentEnvironment.instance().isDefault() ? "source code version" : "Unknown Implementation-VersionUtil In MANIFEST.MF");
