...
public final class ConfigurationFilesUtil {
    ...
    private ConfigurationFilesUtil() {
    }
    ...
    public static Properties loadPropertiesAutomatic(String configName, String configPathName) throws Exception {
        ...
        return t.second
                ? ConfigurationFilesUtil.loadPropertiesClasspath(t.first)
                : ConfigurationFilesUtil.loadPropertiesAbsolute(t.first);
    }
    ...
    public static JSONObject loadJsonAutomatic(String configureName, String configurePathName) throws Exception {
        ...
        return t.second
                ? ConfigurationFilesUtil.loadJsonClasspath(t.first)
                : ConfigurationFilesUtil.loadJsonAbsolute(t.first);
    }
    ...
    public static JSONArray loadArrayAutomatic(String configureName, String configurePathName) throws Exception {
        TwoTuple<String, Boolean> t = getPathAutomatic(configureName, configurePathName);
        return t.second
                ? ConfigurationFilesUtil.loadArrayClasspath(t.first)
                : ConfigurationFilesUtil.loadArrayAbsolute(t.first);
    }
