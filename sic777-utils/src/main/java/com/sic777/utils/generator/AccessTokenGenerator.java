...
public class AccessTokenGenerator {
    ...
    public String next(String customDate) throws NoSuchAlgorithmException {
        return Base64Utils.encode(SHA1Tool.SHA256(customDate + KEY + UUIDGenerator.instance().next()).getBytes());
    }
}
